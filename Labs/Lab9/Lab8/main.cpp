...
void display(void){
    ...
    glTexCoord2f(0.0, 0.0); glVertex3f(1.0, -1.0, 1.0);
    glTexCoord2f(0.0, 3.0); glVertex3f(1.0, -1.0, -1.0);
    glTexCoord2f(3.0, 3.0); glVertex3f(1.0, 1.0, -1.0);
    glTexCoord2f(3.0, 0.0); glVertex3f(1.0, 1.0, 1.0);

    glTexCoord2f(0.5, 0.5); glVertex3f(1.0, -1.0, -1.0);
    glTexCoord2f(0.5, 1.5); glVertex3f(-1.0, -1.0, -1.0);
    glTexCoord2f(1.5, 1.5); glVertex3f(-1.0, 1.0, -1.0);
    glTexCoord2f(1.5, 0.5); glVertex3f(1.0, 1.0, -1.0);

    glTexCoord2f(0.0, 0.0); glVertex3f(-1.0, -1.0, -1.0);
    glTexCoord2f(0.0, 10.0); glVertex3f(-1.0, -1.0, 1.0);
    glTexCoord2f(10.0, 10.0); glVertex3f(-1.0, 1.0, 1.0);
    glTexCoord2f(10.0, 0.0); glVertex3f(-1.0, 1.0, -1.0);
